...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2025 at 07:16 AM
...
(3, 'Jahid Hasan Sohan', 'Admin@gmail.com', 'Admin@1217', 'Admin1234', 'admin', '2025-01-25', '01708769578', 'Network_Admin', 'mirpur,dhaka', 'one-piece-roronoa-relaxed-samurai-pose-desktop-wallpaper.jpg', 'refNameOne', 'ref@gmail.com', '9876543212', 'refNameTwo', 'refNameTwo@gmail.com', '987654321');
...
INSERT INTO `employee` (`employee_Id`, `name`, `email`, `username`, `password`, `role`, `DOB`, `phoneNumber`, `employee_role`, `department`, `location`, `employeeType`, `supervisor`, `picture`) VALUES
(11, 'Amira binte', 'amira@gmail.com', 'amira', 'passW@rd1', 'employee', '', '2024-10-31', 'Technician', 'Technical Support', 'Chittagong City, Chittagong', 'Full-Time', 'Sumaiya Afrin', 'FB_IMG_1724348972317.jpg'),
(12, 'Sumaiya Afrin Shashy', 'sumaiya@gmail.com', 'sumaiya', '123', 'employee', '2024-10-17', '', 'Maintenance Engineer', 'Technical Support', 'Dhaka City, Dhaka', 'Full-Time', 'Md. Jahid', 'FB_IMG_1697617856300.jpg');
...
--
ALTER TABLE `employee`
  MODIFY `employee_Id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
