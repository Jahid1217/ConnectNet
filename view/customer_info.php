...
<body>
    ...
    <?php
        session_start();
        include '../control/customer_searchUser_control.php';
        include '../control/customer_showUser_control.php';
    ?>
    <br>
    <h2>User Data</h2>
    <label for="name">Name:</label>
    <input type="text" name="name" value="" id="customerUser" onkeyup="searchUserCustomer()"  >
    <p id="customerPrint"></p>
    <br>
