<?php
include '../control/admin_profile_control.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="navbar">
    ...
    <div id="profile_user_body">
    <h1 id="profile_user_h1">My Profile</h1>
    <div class="form-row">
        <label for="profile"></label> <span class="value"><?php echo $profile_Picture; ?></span>
    </div>
    <div class="form-row">
